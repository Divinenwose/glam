    ...
    <div className="space-y-6">
      ...
      <div className="grid sm:grid-cols-3 gap-4">
        ...
        <Card className="p-4">
          ...
          <p className="text-2xl font-bold text-gold-500 mt-1">12</p>
        </Card>
        <Card className="p-4">
            ...
            <tbody className="divide-y divide-neutral-200 dark:divide-neutral-700">
              {mockTickets.map((ticket) => (
                <tr key={ticket.id} className="hover:bg-neutral-50 dark:hover:bg-neutral-800">
                  <td className="px-6 py-4 text-neutral-900 dark:text-white">{ticket.user}</td>
                  <td className="px-6 py-4 text-neutral-600 dark:text-neutral-400">{ticket.subject}</td>
                  ...
                  <td className="px-6 py-4 text-neutral-600 dark:text-neutral-400">{formatDate(ticket.date)}</td>
